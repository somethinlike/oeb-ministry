...
function annotationToOffline(ann: Annotation): OfflineAnnotation {
  return {
    ...
    isEncrypted: ann.isEncrypted,
    encryptionIv: ann.encryptionIv,
...
function offlineToAnnotation(off: OfflineAnnotation): Annotation {
  return {
    ...
    isEncrypted: off.isEncrypted,
    encryptionIv: off.encryptionIv,
