...
export function UpdatePrompt() {
  ...
  return (
    <div
      className="fixed bottom-4 right-4 z-50 max-w-sm rounded-lg bg-panel
                 border border-edge shadow-lg p-4"
      role="alert"
    >
      ...
      <button
        ...
        className="mt-3 w-full rounded-lg bg-accent px-4 py-2 text-sm
                   font-medium text-on-accent hover:bg-accent-hover
                   focus:outline-none focus:ring-2 focus:ring-ring"
      >
        Refresh now
      </button>
